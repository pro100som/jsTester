SOmTest.spec={
	task:{
		N: 2,																	// номер задания, используется при сохранении последней отправки
		name: 'isInt',															// имя функции
		in: [																	// входные параметры
			'a',
		],
		text: 'Написать функцию, Проверяющую, является ли <i>a</i> целым числом.',	// текст задания
		...
		output: [																// описание выходных данных
			'передано целое число - вернуть <i>true</i>',
			'передано не целое число - вернуть <i>false</i>',
		],
	},
